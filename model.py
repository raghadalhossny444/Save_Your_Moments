...
class ImageAnalysisPipeline:
    ...
    async def generate_caption(self, results):
        print(results)
        prompt = f"Based on the following analysis results, generate a caption for the image that is engaging but not overly emotional or dry. The caption should describe the scene and its elements in 20 to 50 words:\n{results}"
                ...
                "messages": [
                    {
                        ...
                        "content": [
                            {
                                "type": "text",
                                "text": "Here's an image to be captioned. Generate a meaningful caption for the image in 20-50 words. The caption should be descriptive yet balanced, reflecting the scene and details."
                            },
                            {
                                "type": "image_url",
                                "image_url": {
...
async def main():
    ...
    results = await pipeline.analyze_image(image_path)
    print("Full Pipeline Results:", results)
    
    # GPT-4o mini direct analysis
    gpt4o_result = await pipeline.process_image_gpt4o_mini(image_path)
    print("GPT-4o Mini Result:", gpt4o_result)
